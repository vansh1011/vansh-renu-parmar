...
const About = () => {
  ...
  Let's connect and build something amazing!
        ...
        <img className="absolute md:top-[260px] top-[290px] md:h-[12px] md:w-[170px] h-[7px] w-[100px]" src="../Assests/separatorBlack 1.png" alt="Separator" />
        ...
        <img className="absolute top-[430px] md:h-[12px] md:w-[170px] h-[7px] w-[100px]" src="../Assests/separatorBlack 1.png" alt="Separator" />
      </div>
